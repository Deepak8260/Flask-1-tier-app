...
LINUX_COMMANDS = [
    ...
    {"name": "mkdir", "desc": "Create a new directory.", "example": "mkdir -p projects/devatlas"},
...
DOCKER_COMMANDS = [
    {"name": "docker build", "desc": "Build an image from a Dockerfile in the current directory.", "example": "docker build -t devatlas:latest ."},
    {"name": "docker run", "desc": "Create and start a new container from an image.", "example": "docker run -d -p 5000:5000 devatlas"},
    ...
    {"name": "docker rmi", "desc": "Delete one or more images from the local registry.", "example": "docker rmi devatlas:latest"},
    {"name": "docker pull", "desc": "Download an image from Docker Hub or a registry.", "example": "docker pull python:3.11-slim"},
    {"name": "docker push", "desc": "Upload a local image to Docker Hub or a registry.", "example": "docker push username/devatlas:latest"},
    ...
    {"name": "docker tag", "desc": "Tag an image with a new name or version.", "example": "docker tag devatlas:latest devatlas:v1.0"},
